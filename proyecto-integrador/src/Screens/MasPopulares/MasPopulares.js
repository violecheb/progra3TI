...
const baseURL = `https://api.themoviedb.org/3/movie/top_rated?api_key=16165a70d46ac6b42f11100b26969ebb&language=en-US&page=`;
    ...
    return(
        <div> 
            ...
            {this.state.loading ? 
                ...
                <MoviesList header="Top Rated Movies" movies={peliculasMostradas} path=""/>}
